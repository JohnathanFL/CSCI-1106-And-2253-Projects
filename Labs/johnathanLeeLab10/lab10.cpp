//
// Programmer: Tim Wrenn, modified by Johnathan Lee
//						 This was how you wanted us to do this part,
//						 right?
//
...
void readScore(int &score){
	...
	cout << "Enter an SAT verbal score between " << LOW_SCORE << " and "
		<< MAX_SCORE << " ======> ";
	cin >> score;
}
...
bool outOfRange(int score){
	return (score < LOW_SCORE || score > MAX_SCORE);
}
